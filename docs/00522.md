...
|     US      |            `48`             | <i style="color:#ccc">7</i> |            `37`             |             27              | 119</i> |
|   Canada    | <i style="color:#ccc">5</i> |            `10`             | <i style="color:#ccc">0</i> | <i style="color:#ccc">0</i> |   15    |
|  Australia  | <i style="color:#ccc">0</i> |            `17`             | <i style="color:#ccc">3</i> | <i style="color:#ccc">0</i> |   20    |
| New Zealand | <i style="color:#ccc">4</i> |            `12`             | <i style="color:#ccc">1</i> | <i style="color:#ccc">0</i> |   17    |
|   Ireland   | <i style="color:#ccc">3</i> |             `9`             | <i style="color:#ccc">0</i> | <i style="color:#ccc">0</i> |   12    |
...
| `1649`-`1660`  |       `Monarchy` broken       |                                 |
|     `1660`     |       Charles II throne       |                                 |
|      1664      |                               |         name `New York`         |
|     `1707`     |  `Anne` name `Great Britain`  |                                 |
|      1763      |        `Canada` ceded         |                                 |
|      1764      |       `spinning jenny`        |                                 |
|      1774      |                               |     Congress `Philadelphia`     |
|      1781      |                               | `The Articles of Confederation` |
|      1783      |                               |      `the Treaty of Paris`      |
|      1787      |                               |  Confederation `Philadelphia`   |
|      1787      |                               |    **Constitution** drawn up    |
|      1789      |                               |     **Constitution** effect     |
|      1789      |                               |  George Washington `New York`   |
|      1832      |   `the Reform Act of 1832`    |                                 |
|      1871      | `The Trade Union Act of 1871` |                                 |
|     `1815`     |                               |  largest immigration movement   |
| `1845`-`1854`  |                               |      1.5 million Irishmen       |
|      1853      |                               |       `Mexican Purchase`        |
|      1865      |                               |   `the Thirteenth Amendment`    |
|      1865      |                               |   `General Ulysses S. Grant`    |
|      1869      |                               |   railroad cross the country    |
|      1890      |                               |         `South Dakota`          |
|      1893      |                               |      `the Duryea brothers`      |
|      1900      |                               |         `J. P. Morgan`          |
|     `1914`     |     `Austrain` `Sarajevo`     |                                 |
|   1919-1920    |                               |           `Red Scare`           |
|      1929      |                               |      `the black Thursday`       |
|      1932      |                               |        **The New Deal**         |
...
| **1950-1975**  |                               |        `the longest war`        |
|      1952      |            `smog`             |                                 |
|     1960s      |                               |      Civil Rights Movement      |
|      1962      |                               |  **The Cuban Missile Crisis**   |
|      1972      |                               |             `Nixon`             |
|     `2005`     |     `a terrorist bombing`     |                                 |
|      2008      |                               |         `Barack Obama`          |
|     `2011`     |      crown on a daughter      |                                 |
...
Between `55BC` and `410AD`, Britain was under the Roman occupation, `but it was never a total occupation`.
