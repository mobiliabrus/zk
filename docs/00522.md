...
<ul style="list-style:auto;">
  <li v-for="t in [
  '<u>Alfred</u> is known as “the father of the British navy”.',
  '<u>Britain</u> was the first country to industrialize.',
  '<u>Edmund Cartwright’s power loom</u> eventually enabled weaving to catch up with spinning.',
  '<u>Elizabeth I’s</u> religious reform was a compromise of views.',
  '<u>Farming</u> was an important occupation in England in the 18th century.',
  '<u>Henry Ⅱ</u>was the first king of the House of Plantagenet.',
  '<u>James I</u> of England was the first of the Stuarts to take the throne.',
  '<u>King John</u> defied Magna Carta who had raised troops and ravaged the north.',
  '<u>Oliver Cromwell</u> and the “Rump”－－members of the Long Parliament who had voted for Charles’s execution－－declared England a Commonwealth.',
  '<u>The Anglo-Saxons</u> laid the foundations of the English state.',
  '<u>The Canada Act of 1791</u> divided Canada into Upper Canada and Lower Canada.',
  '<u>The Reform Act of 1832</u> abolished “rotten boroughs”.',
  '<u>The Test Act(1673)</u> excluded all Catholics from public office of any kind.',
  '<u>The Trade Union Act of 1871</u> legalized the trade unions and gave financial security.',
  '<u>William Shakespeare</u> is generally regarded as the greatest writer in the English language.',
  'After Charles I died, <u>Oliver Cromwell</u> became the most powerful man in England.',
  'After the Restoration, the Parliament passed a series of severe laws called _______ against the Puritans, now known as _________. <u>the Clarendon Code, Nonconformists</u>',
  'Armed villagers and townsmen of Kent and Essex, led by <u>Wat Tyler and Jack Straw</u>, moved on London in June 1381, releasing John Ball from Maidstone gaol on the way.',
  'As a result of the rainfall distribution in Britain there is a water surplus in <u>the north and west</u>.',
  'At first the English were brilliantly successful they won a great naval victory at Sluys in <u>1340</u>.',
  'At the battle of Lewes in Sussex in <u>May 1264</u>, the King was defeated by de Montfort and taken prisoner.',
  'Britain has many smaller mammals, and the larger ones tend to be <u>gentle</u>.',
  'By 1453 <u>Calais</u> was the only part of France that was still in the hands of the English.',
  'Canute made England part of a <u>Scandinavian</u> empire.',
  'Changes occurred earliest and quickest in <u>textiles</u>.',
  'Domesday Book was completed in <u>1086</u>.',
  'Elizabeth I came to the throne when she was _______ and then she reigned England, Wales and Ireland for ________ years. <u>25, 45</u>',
  'Elizabeth avoided troubling Parliament too often for pounds by <u>making strict economies</u> at Court.',
  'French rights were guaranteed by <u>the Quebec Act of 1774</u>.',
  'Generally speaking, Elizabeth was able to <u>work with</u> Parliament.',
  'In 1356 at <u>Poitiers</u>the English won another victory over the French King who was taken prisoner and held to ransom.',
  'In <u>1628</u>, Charles I was forced to accept the Petition of Right, regarded as the second Magna Carta.',
  'In <u>1707</u>, the Act of Union united England and Scotland.',
  'In <u>1707</u>, the name Great Britain came into being.',
  'In <u>597</u> St. Augustine became the first Archbishop of Canterbury.',
  'In <u>January 1973</u>, Britain finally became a full member of the European Economic Community.',
  'In pocket boroughs, elections were won by <u>influence</u>.',
  'It was during <u>Anne</u>’s reign that the name Great Britain came into being.',
  'Magna Carta had altogether <u>63</u> clauses.',
  'Of the surviving languages the earliest to arrive in Britain were the two forms of <u>Celtic</u>.',
  'Oliver Cromwell and the “Rump” declared England a <u>Commonwealth</u>.',
  'On <u>July 17, 2013</u>, Queen Elizabeth II approved a same-sex marriage bill..',
  'On <u>July 7, 2005</u>, London suffered a terrorist bombing, Britain’s worst attack since World War Ⅱ.',
  'Red deer live in <u>the Scottish Highlands and Exmoor in southwestern England</u>.',
  'Roe deer are found in <u>the woodlands of Scotland and southern England</u>.',
  'The <u>Beaker Folk</u> brought with them the art of pottery making, the ability to fashion bronze tools and the custom of individual burial.',
  'The <u>Celts</u> began to arrive about 500 BC and kept coming until the arrival of the Romans.',
  'The <u>Roman</u> had no impact on the language or culture of ordinary Britons.',
  'The Anglo-Saxons brought <u>Teutonic</u> religion to Britain.',
  'The Celts may originally have come from eastern and central Europe, now France, <u>Belgium</u> and southern Germany.',
  'The English Civil War is also called <u>the Puritan Revolution</u>.',
  'The English Civil War is generally regarded as the beginning of modern <u>world</u> history.',
  'The English Renaissance was largely literary, and achieved its finest expression in <u>Elizabethan drama</u>.',
  'The Glorious Revolution took place in <u>1688</u>.',
  'The Grand Council met <u>three</u> times a year in the southern cities of Winchester, Westminster and Gloucester.',
  'The Independent Labor Party was led by <u>Keir Hardie</u>.',
  'The Lollards went about preaching the equality of men before God, the most famous one being <u>John Ball</u>.',
  'The Norwegian Vikings and the Danes from Denmark attacked various parts of England from the end of the <u>8th</u> century.',
  'The Renaissance was typified by <u>Leonardo da Vinci</u>.',
  'The UK has a <u>maritime</u> climate.',
  'The UK is an island country which lies between latitude <u>50° to 60°</u> north.',
  'The Wars of the Roses was caused by the two branches of the Plantagenet family between _______ and _______. <u>1455, 1485</u>',
  'The barons forced the King and his son Prince Edward to swear to accept <u>the Provisions of Oxford</u>.',
  'The barons, under <u>Simon de Montfort</u>, Henry Ⅲ’s brother-in-law, rebelled.',
  'The channel tunnel, which is called “Chunnel,” was open to traffic in <u>May 1994</u>.',
  'The destruction of Spanish Armanda, in <u>1588</u>, showed England’s superiority as a naval power, and enabled England to become a great trading and colonizing country.',
  'The economic causes of the Hundred Years’ War were connected with <u>Flanders</u>.',
  'The first known settlers of Britain were the <u>Iberians</u>.',
  'The last native speakers of Cornish died in <u>the 18th century</u>.',
  'The name Wars of the Roses was coined by the <u>19th</u> century novelist Sir Walter Scott.',
  'The narrowest part of the English Channel is called <u>the Straits of Dover</u>.',
  'The only surviving large mammals are <u>red deer and roe deer</u>.',
  'The real “revolution” in textiles was in <u>1770</u> when power- driven machinery was introduced.',
  'The reign of <u>Elizabeth I</u> was greeted with relief and a high tide of nationalism. England has been Protestant ever since.',
  'The territorial causes of the Hundred Years’ War were especially bound up with the possession by the English kings of <u>the large duchy of Aquitaine</u>.',
  'Which of the following is Not true about Oliver Cromwell? <u>Cromwell wasn’t a tyrant.</u>',
  'Which of the following is not the finest exponents of the Elizabethan drama? <u>Leonardo da Vinci</u>',
  'Which of the following was Not a consequence of the Wars of the Roses? <u>Ordinary people were greatly affected.</u>',
  'William Shakespeare wrote <u>37</u> plays, such as Romeo and Juliet, Hamlet and The Merchant of Venice, besides his sonnets.',
  'William and Mary jointly accepted <u>the Bill of Rights(1689)</u>.',
  'William gave <u>his barons</u> large estates in England in return for a promise of military service and a proportion of the land’s produce.',
  'With the coming to power of <u>Adolf Hitler</u> and Nazism in Germany, the Versailles arrangements began to crumble.',
]" v-html="t"></li>
</ul>
...
<ul style="list-style:auto;">
  <li v-for="t in [
  '<u>Britain and France</u> could buy arms and war materials from the US.',
  '<u>Chicago</u> is the largest industrial and commercial center of The Midwest.',
  '<u>George Washington</u> was chosen as the first American President.',
  '<u>Georgia</u>, the last of the original 13 colonies, was settled in 1733.',
  '<u>Grammar schools</u> prepare them for higher education.',
  '<u>London</u> is home to many museums and theaters.',
  '<u>Mobility</u> is considered to be one of the characteristics of the American people.',
  '<u>New York</u> City is the most populous city in the United States.',
  '<u>Secondary modern schools</u> prepare them for jobs that do not require higher education.',
  '<u>The British Museum</u> in London houses historical artifacts from all parts of the globe.',
  '<u>The Midwest</u> is America’s most important agricultural area.',
  '<u>The Mississippi</u> has been called “father of waters” or “old man river.”.',
  '<u>The Nineteenth Amendment</u> to the Constitution, adopted in 1919, gave women the right to vote.',
  '<u>The secretary of state</u> has the duty to establish a national curriculum applicable to all state schools.',
  'A new period of neo-liberal economics began in 1979 with the election of <u>Margaret Thatcher</u> who won the general election on 3 May.',
  'According to American historians and specialists in demography, that is, the study of statistics related to population, there are <u>four</u> great population movements in the history of the United States.',
  'All hospital treatment under the NHS is <u>free</u>.',
  'Apart from the reigning <u>king or queen</u>, British Parliament has two parts.',
  'At public housing’s peak, local governments owned <u>30%</u> of all housing in the country.',
  'At the <u>1896</u> Games weight lifter Launceston Elliot was the first Briton to win a gold medal.',
  'Between 1980 and 1989, the South and West of the United States added <u>8.9</u> million people through net migration.',
  'Britain has been an active member of the North Atlantic Treaty Organization (NATO), deploying its <u>troops</u> in various theaters of conflict.',
  'By contrast, the UK has larger energy resources—including <u>oil, natural gas, and coal</u> —than any other EU member.',
  'By the beginning of the 21st century, the proportion of homes owned by local governments had <u>almost halved</u>.',
  'Capital punishment was abolished in <u>1965</u>.',
  'Community councils perform a similar role in Wales, whereas community councils in Scotland are voluntary and consultative bodies with <u>few</u> statutory powers.',
  'During <u>the mid-20th century</u>, local government developed council houses throughout the UK.',
  'Each part of the UK has a distinct system of local government.Local governments have very few legislative powers and must act within the framework of laws passed by <u>the central Parliament</u> (and by the Scottish Parliament in Scotland).',
  'Fish farming---mainly of <u>trout and salmon</u>---has expanded considerably.',
  'Greater London and each of the metropolitan counties also constitute <u>ceremonial</u> and geographic counties.',
  'Hispanic and Latino Americans accounted for <u>48%</u> of the national population growth of 2.9 million between July 1, 2005, and July 1,2006.',
  'Hospitals absorb more than <u>two-thirds</u> of the NHS budget.',
  'In 1903,<u>the Wright brothers</u> flew an aeroplane for a brief 12 seconds at Kitty Hawk, North Carolina.',
  'In 1911<u>Glenn E. Curiss</u> designed and flew a successful plane.',
  'In 1990, <u>George H. W. Bush</u> signed the Immigration Act of 1990, which increased legal immigration to the United States by 40%.',
  'In <u>1814</u>, British and American diplomats signed a peace treaty which said that all was to be as it had been before the war.',
  'In <u>1820</u> Congress reached an agreement known as the Missouri Compromise.',
  'In <u>1854</u> Congress passed the controversial Kansas-Nebraska Act.',
  'In <u>1863</u> Lincoln issued the Emancipation Proclamation, a document that freed the slaves in the Southern states.',
  'In <u>1863</u> the Union Army won major battles at Gettysburg in Pennsylvania and Vicksburg in Mississippi.',
  'In <u>1908</u>, figure skater Madge Cave Syers became the first female athlete to win a medal in the Winter Olympic Games.',
  'In <u>1976</u>, the UK was forced to request a loan of ￡2.3 billion from the International Monetary Fund(IMF).',
  'In <u>2000</u> a new Greater London Authority (GLA) was established with very limited revenue-gathering powers but with responsibility for public transport, policing, emergency services, the environment, and planning in Greater London as a whole.',
  'In Britain, a small number of private schools provide education for about <u>one-twentieth</u> of children.',
  'In Scotland only civil matters may be appealed to <u>the House of Lords</u>.',
  'In September 1774, the First Continental Congress was held in <u>Philadelphia</u> which encouraged Americans to refuse to buy British goods.',
  'In much of Northern Ireland and in some scattered LEAs in Great Britain, pupils take an intelligence examination at age <u>11</u>.',
  'In the UK, the <u>prime minister</u> is the head of government.',
  'In the late 15th century, <u>Christopher Columbus</u> thought he had reached Asia and didn’t know he had discovered a New Continent.',
  'In the presidential election of 1860, <u>Abraham Lincoln</u> became the new president.',
  'On July 4,<u>1776</u>, the Congress adopted the declaration of Independence.',
  'Pupils may stay on past the minimum leaving age of <u>16</u> to earn a certificate or take public examinations that qualify them for higher education.',
  'Queen <u>Elizabeth II</u> began to undertake public duties during the Second World War, in which she served in the Auxiliary Territorial Service.',
  'Recruited from successful practicing lawyers, judges in the UK are appointed and virtually <u>irremovable</u>.',
  'Responsibility for national defense rests with the <u>prime minister</u> and the cabinet.',
  'Secondary education is free and compulsory to age <u>16</u>.',
  'The <u>BBC</u> held a monopoly of both radio and television broadcasting until 1954.',
  'The <u>English</u> founded their first permanent settlement on the continent at Jamestown, Virginia, in 1607.',
  'The <u>first</u> population movement was between the end of the civil war and 1880 when the westward movement came to a halt.',
  'The American Civil War began in <u>1861</u>.',
  'The American War of Independence began in <u>1775</u>.',
  'The BBC was set up as an independent public corporation in <u>1927</u>.',
  'The British <u>Lords</u> is made up of peers of the realm (members of the nobility or Lords Temporal), the highest clergy in the Church of England (Lords Spiritual), and the highest judges (Law Lords).',
  'The British <u>police</u>, popularly known as “bobbies,” wear a uniform that is nonmilitary in appearance.',
  'The Community Health Service has <u>three</u> functions.',
  'The Conservatives, led by <u>David Cameron</u> since the end of 2005, had the largest number of seats.',
  'The English founded their first permanent settlement on the continent at Jamestown, <u>Virginia</u>, in 1607.',
  'The House of Commons is elected for a maximum term of <u>five</u> years.',
  'The ITC’s governing board has <u>10</u> members.',
  'The Immigration and Nationality Act of <u>1965</u>, also known as the Hart-Cellar Act, abolished the system of national-origin quotas.',
  'The Law Lords include <u>12</u> judges of the Supreme Court of Judicature(the Court of Appeal and the High Court of Justice), who are all also life peers.',
  'The Middle Atlantic States have about <u>one fifth</u> of the total population of the United States.',
  'The Mississippi is <u>3, 782</u> kilometers long.',
  'The NHS is almost entirely funded by government revenues, with less than <u>5%</u> of NHS revenue coming from charges.',
  'The Panama Canal opened in <u>1914</u>.',
  'The UK has <u>no</u> national police force or any minister exclusively responsible for the police.',
  'The UK has limited supplies of mineral resources. The once-important extraction of <u>iron ore</u> has dwindled to almost nothing.',
  'The UK’s biggest-selling newspaper is <u>the Sun</u>.',
  'The United States Census Bureau defines <u>White people</u> as those “having origins in any of the original peoples of Europe, the Middle East, or North Africa”.',
  'The United States government declared war on Germany on <u>April 6, 1917</u>.',
  'The United States was formally in war with the Axis powers, that is, <u>Germany, Italy and Japan</u>.',
  'The United States went to war with Britain in <u>1812</u>, the last war fought between these two countries.',
  'The first American Congress met on April 6, <u>1789</u>.',
  'The first American general election was held in <u>1788</u>.',
  'The first important national labor organization in the United States was the Knights of Labor (KOL), founded in <u>1869</u>.',
  'The independent Arts Council, formed in <u>1946</u>, supports many kinds of contemporary creative and performing arts.',
  'The magistrate decides whether the accused should be held on <u>bail</u> or in custody.',
  'The modern game of <u>football</u> is generally accepted to have originated in England.',
  'The new land was named America after <u>Amerigo Vespucci</u>.',
  'The present Sovereign is Queen Elizabeth II. Elizabeth was born in London and educated privately at home. Her father acceded to the throne as George VI in <u>1936</u> on the abdication of his brother Edward VIII, from which time she was the heir presumptive.',
  'The satellite and cable market is dominated by <u>BSkyB</u>.',
  'The second English colony to be established in America was <u>Plymouth</u>.',
  'The southeastern coast is <u>warmed</u> by the Gulf Stream.',
  'The total fertility rate in the United States for 2013 was <u>1.87</u> children per woman, which was below the replacement fertility rate of approximately 2.1.',
  'The upper house, or House of Lords, is the older of the two parts of Parliament. It originated in the <u>11th</u> century with the councils of nobles and high clergy who were the closest advisers to the monarch.',
  'The work of filmmakers and actors throughout the UK is supported by <u>Film Council</u>, a government board that helps fund productions and secure film-related services.',
  'Unemployment had fallen below 3 million by the time of Thatcher’s <u>third</u> successive election victory in June 1987.',
  'Which of the followings is not the function of the Community Health Service? <u>To provide dentistry and pharmaceutical and ophthalmic (related to the eyes) services</u>',
]" v-html="t"></li>
</ul>
...
<ul style="list-style:auto;">
  <li v-for="t in [
  '<u>Christianity</u> is the principal religion in Canada.',
  '<u>Churches</u>are more concerned about broader issues of policy that can affect their organizations or their beliefs.',
  '<u>Education</u> in the United States is and has historically been provided by government of three levels: federal, state and local.',
  '<u>English and French</u> is/are official languages of Canada.',
  '<u>Ernest Hemingway</u>, the 1954 Nobel laureate, is often named as one of the most influential writers of the 20th century.',
  '<u>Ice hockey</u> is Canadian in tradition and leadership, and it remains one of the country’s favorite winter sports.',
  '<u>Ice hockey</u> is the fourth leading professional team sport.',
  '<u>Independence Day</u> is July 4.',
  '<u>Martin Luther King, Jr. Day</u> is celebrated on the third Monday in January.',
  '<u>Memorial Day</u> is observed on the last Monday of May.',
  '<u>Montreal</u>, situated at the meeting point of the Ottawa and St. Lawrence rivers, is often described as the largest French-speaking city outside France.',
  '<u>Nebraska</u> has unicameral legislature.',
  '<u>Ottawa</u> is the capital of Canada.',
  '<u>Ottawa</u> is the fourth largest city in Canada.',
  '<u>O’Neill</u> is a four-time winner of the Pulitzer Prize for drama and the only American playwright to win the Nobel Prize for literature.',
  '<u>Reagan</u> proposed reductions in personal and business income taxes along with cuts in social-welfare programs.',
  '<u>Separatist Congregationalists</u> founded Plymouth Colony in 1620.',
  '<u>The Indians</u> are the largest of the aboriginal groups.',
  '<u>The United States</u> considered attacking Cuba via air and sea, but decided on a military blockade instead, calling it a “quarantine” for legal and other reasons.',
  '<u>Toronto</u> is the largest city in Canada.',
  '<u>Washington’s Birthday</u> is observed on the third Monday of February in honor of George Washington, the first President of the United States.',
  'About four fifths of cropland is in <u>the Prairie Provinces</u> in Canada.',
  'After the Fifteenth Amendment to the United States Constitution was ratified in <u>1870</u>, giving African American men the right to vote.',
  'All representatives serve <u>a two-year</u> term in the House of Representatives.',
  'American football games usually include <u>cheerleaders</u> and marching bands, which aim to raise school spirit and entertain the crowd at half-time.',
  'America’s first internationally popular writers were James Fenimore Cooper and Washington Irving in the early <u>19th</u> century.',
  'Bill Clinton, the governor of Arkansas, won the <u>1992</u> Democratic presidential nomination after a rocky start in the early primaries.',
  'Both English and French are official languages of Canada, but <u>English</u> is dominant in most of the country.',
  'By <u>1920</u>, the Nineteenth Amendment to the United States Constitution gave women the right to vote.',
  'Canada became independent in <u>1867</u>.',
  'Canada became independent through <u>the British North America Act</u>.',
  'Canada consists of 10 provinces and <u>three</u> territories that vary greatly in size.',
  'Canada covers about <u>two fifths</u> of the North American continent.',
  'Canada exports large amounts of lumber, mostly to <u>the United States</u>.',
  'Canada’s native, or aboriginal, people are <u>the Indians and the Inuit</u>.',
  'Champlain founded France’s first permanent Canadian colony in <u>Quebec</u>.',
  'College<u>basketball</u> is also popular, also known as March Madness.',
  'During Bush’s first year in office the regimes of <u>Eastern Europe</u> collapsed.',
  'French settlers established a settlement at Port Royal in<u>1605</u>.',
  'French settlers led by the explorer <u>Samuel de Champlain</u> established a settlement at Port Royal.',
  'From 1972 to 1979, the key problem that affected the progress in US-China relations remained the <u>Taiwan</u> problem.',
  'If the president dies, resigns, or is removed from office, <u>the vice president</u> becomes president.',
  'In 1497 <u>John Cabot</u> sailed west from England hoping to find a new trade route to Asia.',
  'In 1989 the Berlin Wall was breached, and in 1990 East and West Germany were reunited after nearly <u>45</u> years.',
  'In 2012, <u>Ottawa</u> was ranked for the third consecutive year as the best community in Canada to live in.',
  'In <u>1787</u> , Congress called for a meeting of delegates from all the states to revise the Articles of Confederation.',
  'In <u>1954</u>, the Supreme Court ruled that separate schools for black children were not equal to schools for white children.',
  'In April 1992 racial tensions exploded into severe rioting in parts of<u>Los Angeles</u>.',
  'In December 1954, the US government signed a Mutual Defence Treaty with the Chiang Kai-shek regime on <u>Taiwan</u>, commiting itself to the defense of Taiwan and Peng-hu.',
  'In December <u>1954</u>, the Senate condemned McCarthy for certain improper, extreme behavior.',
  'In February 1972, President <u>Nixon</u> visited China and met Chairman Mao Zedong and the two countries issued the Shanghai Communique.',
  'In May 1962 Nikita Khrushchev proposed the idea of placing Soviet nuclear missiles on <u>Cuba</u> to deter any future invasion attempt.',
  'In U.S.,Widespread activism for civil rights did not really begin until after <u>World War II</u>.',
  'In a wide belt between the Canadian Shield and the western mountains, stretching from the border with the United States to the shores of the Arctic Ocean, is the region known as <u>the Interior Plains</u>.',
  'In almost all schools at these levels, children are divided by <u>age</u> groups into grades.',
  'In general, America has a <u>two-party</u> system.',
  'In most states members of the lower house serve <u>2-year</u> terms.',
  'In the two Taiwan Straits crises of 1954 and 1958, the <u>United States</u> provided Chiang with military aid and considered, on several occasions, the use of tactical nuclear weapons against military targets on the mainland of China.',
  'Jacques Cartier entered the Gulf of Saint Lawrence and claimed the area for <u>France</u>.',
  'Jacques Cartier entered the Gulf of Saint Lawrence in <u>1534</u>.',
  'James Meredith became the first black person to graduate from the University of <u>Mississippi</u>.',
  'John Cabot found his way to <u>eastern Canada</u>.',
  'Like federal politics, the topic of <u>religion</u> in the United States can cause an emotionally heated debate over moral, ethical and legal issues affecting Americans of all faiths in everyday life.',
  'McCarthy in the end <u>destroyed</u> himself with his extreme accusations and activities.',
  'Most of Canada is north of the <u>49th</u> parallel.',
  'New China signed a mutual alliance treaty with the Soviet Union in early <u>1950</u>.',
  'Ocean currents have the strongest effect on climate along <u>the Pacific coast</u>.',
  'On February 22, 1946, <u>George Kennan</u>, a high-ranking official in the American embassy to Moscow, sent a long telegram to the State Department, analyzing Soviet intention and putting forward suggestions.',
  'On March 30, 1981, <u>Reagan</u> was shot by John Hinckley Jr., as he left a Washington DC hotel.',
  'On November 22, 1963, President <u>Kennedy</u>was fatally shot in Dallas while on a tour of Texas.',
  'On November 8, 1984, <u>Reagan</u> was re-elected in a landslide victory over the Democratic candidate, former Vice President Walter.F. Mondale.',
  'Only <u>three</u> natural passes cut through the Canadian Rockies.',
  'Pennsylvania was established by <u>Quakers</u>.',
  'Reagan\'s proposed Strategic Defense Initiative was designed to protect the population of the United States against potential nuclear attacks from <u>the Soviet Union</u>.',
  'Republic of <u>Germany</u> officially came into being on May 23, 1949 and Adenauer was elected Chancellor.',
  'Richard Nixon, who was elected on a platform of ending the Vietnam War, changed the strategy into “Vietnamization” of the war by building up South Vietnamese troops to replace <u>American</u> fighting forces.',
  'Robert Fulton invented <u>the steamboat</u>.',
  'Samuel Morse invented <u>the telegraph</u>.',
  'Social commentary has also been a preoccupation of American <u>theater</u>, often addressing issues not discussed in the mainstream.',
  'Southwestern Ontario produces large amounts of <u>grain com, soybeans, and white beans</u> in Canada.',
  'Special interest groups advocate the cause of their <u>specific</u> constituency.',
  'The <u>Lumiere</u> Brothers are generally regarded as the father of modern cinema.',
  'The Congress of the United States has two sections.They are <u>the House of Representatives and the Senate</u>.',
  'The Constitution Act assigns specific responsibilities to the provinces and reserves all others for <u>the federal government</u>.',
  'The Cuban Missile crisis is generally regarded as the moment in which <u>the Cold War</u> came closest to turning into a nuclear conflict.',
  'The Cuban missile crisis was a <u>14-day</u> confrontation in October 1962 between the Soviet Union and Cuba on one side and the United States on the other side.',
  'The Governor-General is appointed by the <u>monarch</u> in consultation with the prime minister.',
  'The House of Representatives currently consists of <u>435</u> voting members.',
  'The National Gallery of Canada in <u>Ottawa</u>, dating from 1880, houses the most extensive collection of art by Canadians.',
  'The Smith Act, which was passed by Congress in the spring of 1940, made it unlawful for any group to advocate or teach the violent overthrow of government in <u>the United States</u>, or for any person to belong to such a group.',
  'The Soviet collapse left <u>the United States</u> with undisputed status as the world’s most powerful country.',
  'The Supreme Court of Canada was established by the federal government in <u>1875</u>.',
  'The cinema of <u>the United States</u>, often generally referred to as Hollywood.',
  'The end of the long <u>Cold War</u> rivalry opened a new era in the history of not only the United States but also the rest of the world.',
  'The first Bible printed in a <u>European</u> language in the Colonies was by German immigrant Christopher Sauer.',
  'The government is divided into three branches，they are <u>the legislative, the executive and the judicial</u>.',
  'The number of representatives each state has in the House is based on each state’s <u>population</u> in the House of Representatives.',
  'The president holds office for <u>four years</u> now in the USA.',
  'The projection of <u>the Canadian Shield</u> is known as the Frontenac Axis.',
  'The provinces have control mainly over matters of local or private concern, including <u>direct taxes for provincial purposes</u>.',
  'The provincial legislatures are elected for <u>five-year</u> terms.',
  'The richness of its soils has helped make <u>the Great Lakes-St. Lawrence Lowlands</u> the most populous in Canada and one of the country’s main agricultural regions.',
  'The violation of the Bill of Rights and widespread persecution of Communists and progressive people was started by President <u>Truman</u>.',
  'There are <u>four</u> large dialect regions in the United States.',
  'There are three general types of city government: <u>the mayor-council, the commission, and the council-manager</u>.',
  'To a lesser degree in the early <u>21st</u> century, film types that were previously considered to have only a minor presence in the mainstream movie market began to arise as more potent American box office draws.',
  'Towered over by the Coast Mountains, <u>Vancouver</u>’s harbor is Canada’s largest, busiest, and most picturesque.',
  'Which auther did not establish a distinctive American literary voice in the middle of the 19th century? <u>James Fenimore Cooper</u>',
  'Which of the followings is NOT true about Interest Groups? <u>Ethnic groups will support protection for collective bargaining.</u>',
  'Which of the followings is NOT true about Party? <u>America has a one-party system.</u>',
  'Which of the followings is NOT true? <u>Canada is a member of the EU.</u>',
  'World WarⅡ finally ended in September <u>1945</u>.',
]" v-html="t"></li>
</ul>
...
<ul style="list-style:auto;">
  <li v-for="t in [
  '<u>Australia</u> is sometimes called “the land down under”.',
  '<u>Australia</u> is the flattest, most arid, and least populated of the inhabited continents.',
  '<u>Canberra</u> is the federal capital of Australia.',
  '<u>Dublin</u> is the capital of Ireland. It is the center of the country’s economy and culture.',
  '<u>Eucalyptus trees</u>, which are often called gums, are common in the highlands of the south and along the edges of the deserts.',
  '<u>Fishermen and hunters</u> first arrived in Ireland from England in about 6000 BC.',
  '<u>Irish</u> is a minority but official language of the Republic of Ireland.',
  '<u>Massachusetts</u> is the most Irish of US states with 23.8% of the population claiming Irish ancestry.',
  '<u>Melbourne</u> is Australia’s second largest city in terms of population, but it has always vied with Sydney in terms of size, culture, and influence.',
  '<u>Shannon Airport</u> near Limerick, was the world’s first duty-free airport.',
  '<u>Six</u> colonies federated to form the Commonwealth of Australia in 1901.',
  '<u>Sydney</u> is home to Australia’s largest population.',
  '<u>The Four Courts</u> is the seat of Ireland’s judicial branch.',
  '<u>The prime minister</u> is the actual leader of the government.',
  '<u>The red pohutukawa</u> is called New Zealand Christmas tree because it flowers in December.',
  '<u>Wellington</u> is the capital of New Zealand.',
  'A missionary visit <u>in 1814</u> led to the founding of the first Christian mission station at the Bay of Islands',
  'A voluntary health insurance program was established by law in <u>1957</u>.',
  'At its founding in the late <u>1700s</u>, Australia was a prison colony.',
  'At the beginning of the 21st century the ethnic makeup of New Zealand were <u>European, Maori, Asian</u> and other Pacific peoples.',
  'At the time of the first European contact in the 1780s, the Aborigines and Torres Strait Islanders spoke perhaps <u>250</u> languages and about 700 dialects in Australia.',
  'Australia is located to the south of <u>Asia</u>.',
  'Drought is a fact of life in Australia. There have been nine major droughts since European colonization in <u>1788</u>.',
  'Dublin is known for its <u>theaters and writers</u>.',
  'Health services are administered by <u>8</u> regional health boards under the general supervision of the Department of Health and Children.',
  'In <u>1770</u>, the British captain James Cook landed in southeastern Australia near what is now Sydney and claimed the land for Britain.',
  'In some mountainous areas of the South Island it is almost <u>subarctic</u>.',
  'In the far <u>north</u> it is subtropical in New Zealand.',
  'Ireland entered into the European Communities in <u>1973</u>.',
  'Ireland has been inhabited for about <u>8000</u> years.',
  'Ireland’s agricultural activities consist largely of the grazing of <u>cattle and sheep</u>.',
  'Many restaurants now serve a mixture of <u>Eurasian</u> ethnic foods in Australia.',
  'Mineral exploration during the 1960s and early 1970s led to the discovery of a large deposit of <u>zinc ore</u> at Navan in northeast Ireland.',
  'More than <u>90%</u>of Australia’s population lives in cities and towns.',
  'Mount Victoria rises <u>196</u> meters near the center of the city.',
  'Much of the world’s wool comes from <u>Australia</u>.',
  'New Zealand became a fully independent country in <u>1947</u>.',
  'New Zealand has a parliamentary form of government based on the <u>British</u> model.',
  'Noncontributory old-age pensions paid for from government revenues were introduced in <u>1898</u>.',
  'Pay-related social insurance is paid by most employees age <u>16</u> and over.',
  'Peat moss covers about <u>a tenth of</u> Ireland’s land area.',
  'Perhaps the most prominent Irish-born artist of the postwar period was <u>Francis Bacon</u>, who became known for his brutal figurative paintings.',
  'Southeast coastland is the most pleasant part of the country and the forests are unique but it is not <u>Australia</u>’s most common environment.',
  'The <u>British</u> Privy Council acts as the final court of appeal for New Zealand.',
  'The Australian Constitution consists of <u>eight</u> parts or chapters.',
  'The Australian federal government is largely funded through <u>income taxes</u>, which it alone has the right to collect.',
  'The Federal Court of Australia was established in <u>1977</u>.',
  'The Industrial Development Authority, established in the 1950s, encouraged <u>new industry from abroad</u>.',
  'The Irish republic is a <u>parliamentary democracy</u>.',
  'The New Zealand’s culture shows the strong influence of <u>the Maori</u> people.',
  'The author of Ulysses is <u>James Joyce</u>.',
  'The average maximum temperature in <u>Auckland</u> is 23℃ in summer, 14℃ in winter.',
  'The country’s head of state, the president, is elected directly by the public for a term of <u>7</u> years.',
  'The eastern part of Australia is a <u>highland</u>.',
  'The first European shore stations in New Zealand were established <u>after 1790</u>.',
  'The highest rainfall is on the <u>west</u> coast in New Zealand.',
  'The islands remained unknown to the Western world until <u>1642</u>.',
  'The islands remained unknown to the Western world until <u>Abel Tasman</u> sailed along their western shoreline.',
  'The largest city and commercial center of New Zealand is <u>Auckland</u>.',
  'The largest component of the Australian economy is the <u>service</u> sector.',
  'The lowest annual rainfall occurs at Lake Eyre in South Australia, which has only <u>100</u>mm.',
  'The official language of Australia is <u>English</u>.',
  'The secondary school system comprises private schools that are predominantly owned by <u>religious communities</u>.',
  'The stream of Irish literature that has enriched world culture has been almost entirely written in <u>English</u>.',
  'There is universal suffrage for those <u>18</u> years of age and older New Zealand.',
  'Three fourths of New Zealanders live on the <u>North Island</u>.',
  'Traditional Maori social organization was based on <u>clans of extended families</u>.',
  'Two Irish dramatists won Nobel Prizes for Literature, <u>George Bernard Shaw and Samuel Beckett</u>.',
  'Wellington is located at the <u>southern</u> tip of the North Island.',
  'Which of the followings is NOT true about the climate of New Zealand? <u>It rains more in the summer.</u>',
  'Which of the followings is NOT true about the daily life and social customs of Ireland? <u>Ireland culture is single national.</u>',
  'Which of the followings is NOT true about the plants of New Zealand? <u>There are still large areas, particularly on the east coast of the South Island.</u>',
  'Which one is not the chief crops of New Zealand? <u>potato</u>',
  'Zealand law usually follows the precedents of <u>English</u> law.',
]" v-html="t"></li>
</ul>
...
- `Black Death`:
  1. It was a `deadly plague` spread by `rat fleas` in 14th century.
  2. It spread through `Europe` in the middle of `14th century` and reached England in the summer of 1348.
  3. Many `people died` and the `population of England shrank`.
  4. It caused `labor shortage` and other social problems.

- `Margaret Thatcher`:
  1. She was the `first woman Prime Minister` in British history.
  2. She had her administration for `two terms` (1979-1990).
  3. She gained her reputation as the `"iron lady"` for her tight control of Britain’s monetary policy.
  4. Mrs. Thatcher gained `prosperity of Britain in 1980s`.

- `The American Revolution`:
  1. Also known as `the War of Independence` or `Revolutionary Way`, it `began in 1775` and `concluded in 1783`.
  2. It `ended` two centuries of `British rule` for most of the North American colonies and `created the United States of America`.

- `The Great Lakes`:
  1. These are the `most important lakes in America,` extending about 1600 kilometers and forming a section of the `boundary between the United States and Canada`.
  2. The Great Lakes include `Lake Michigan`, `Lake Superior`, `Lake Huron`, `Lake Erie` and `Lake Ontario`.

- `Australian aborigines`:
  1. Australian aborigines were the `first settlers in Australia`.
  2. For generations they were `subjected` to policies which `segregated` them on reserves and missions.
  3. In `1967`, they `gained Australian citizenship`.
  4. Since then, they have struggled to restore a sense of indigenous history, dignity and economic vitality to their diverse peoples.

- `Wars of the Roses`:
  1. Coined by `Sir Walter Scott`,
  2. the name Wars of the Roses refers to the battles between the `great House of Lancaster`, `symbolized` by the `red rose`, 
  3. and that of York `symbolized` by the `white rose`.
  4. The battles were fought between `1455` and `1485`.

- `the Emancipation Proclamation`:
  1. During the `Civil War`, `President Lincoln` issued the Emancipation Proclamation in `1863` to get more support for the Union at home and abroad.
  2. It `abolished slavery` and `granted freedom to all slaves`.

- `Open University in the UK`:
  1. The Open University in the UK is a `unique innovation` in `higher education`.
  2. It is a `degree-granting institution` that `provides courses for adults` through television, radio, and local study programs.
...
- `The U.S. Presidency`:
  1. The U.S. President of the United States is `head of the executive branch`.
  2. The `White House` is his official residence.
  3. He is head of state `elected by the whole nation`.
  4. His status makes him the most prominent figure as the `first citizen` and his `wife` is called the `First Lady`.
...
- `King Alfred`:
  1. King Alfred was an `English king of the 9th century` 
  2. who `reorganized the army` and `established the navy`.
  3. He `encouraged learning`, `established schools` and `formulated a legal system`.
  4. His admirable achievement earned him the title “`Alfred the Great`”.

- `The Norman Conquest`:
  1. The Norman Conquest of 1066 is perhaps the `best-known event in English history`.
  2. William the Conqueror `confiscated almost all the land` and gave it to his Norman followers.
  3. He `replaced the weak Saxon rule` with a strong Norman government.
  4. So the `feudal system was completely established in England`.
