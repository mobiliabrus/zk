...
> <v-dict word="nominal"></v-dict> adj. relating to or constituting or bearing or giving a name;
...
> <v-dict word="collapse"></v-dict> v.崩溃/倒塌

> <v-dict word="shrink"></v-dict> v.收缩

> <v-dict word="rapidly"></v-dict> adv.迅速地
...
> <v-dict word="demonstrator"></v-dict> n.示威者
...
> <v-dict word="dominant"></v-dict> adj.占主导地位的

> <v-dict word="sector"></v-dict> n.（尤指一国经济的）领域

> <v-dict word="inflation"></v-dict> n.通货膨胀
...
> <v-dict word="stagnation"></v-dict> n.停滞；萧条
...
> <v-dict word="reprieve"></v-dict> n.缓刑;

> <v-dict word="pardon"></v-dict> n.原谅; 赦免; 宽恕; 特赦;
...
> <v-dict word="representative"></v-dict> n.代表；

> <v-dict word="naturalists"></v-dict> n.博物学家；自然主义者；
...
> <v-dict word="elementary"></v-dict> adj.初级的

> <v-dict word="compulsory"></v-dict> adj.强制性的
...
> <v-dict word="patriotic"></v-dict> adj.爱国的
...
> <v-dict word="numerous"></v-dict> adj.很多的

> <v-dict word="heterogeneous"></v-dict> adj.各种各样的
...
> <v-dict word="plateau"></v-dict> n.高原
...
> <v-dict word="humid"></v-dict> adj.潮湿的
...
> <v-dict word="stroke"></v-dict> n. (游泳或划船的)划

> <v-dict word="crawl"></v-dict> vi. 爬行
...
> <v-dict word="penal"></v-dict> adj. 刑事的
...
> <v-dict word="referendum"></v-dict> n. 公民投票
