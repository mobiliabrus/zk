  2. aim to create a Norther Ireland Assembly
- St. Patrick's Day
  1. March 17
- U.S. Presidency
  1. head of the executive branch
- U.S. checks and balances
  1. Congress pass a law
  2. president van veto, or cancel it
- branches of U.S. government
  1. legislative
  2. executive
  3. judicial
- Federalist Papers
  1. newspapers of New York City carried 85 letters
- political equality of the black people
  1. the Civil Rights Act of 1964
  2. the Voting Rights Act of 1965
- the Great Depression
  1. stock market collapse was the beginning
- the New Deal
  1. a program by President Franklin D. Roosevelt, to deal with the Great Depression
- Muckrakers
  1. a group of reform-minded journalists
- Nixon and China
  1. the Shanghai Communique

## 真题

- William the Conqueror, `the Grand Council`
- the last of the five `Tudor` monarchies, Henry VII, Henry VIII, Edward VI, Mary I, `Elizabeth I`
- `The Midwest` Interior Plains in the US
- World War I, the US `isolationism`
- the worst economic recession in the US, `The 2008 financial crisis`
- Canada's vast territory, from the North Pole to the `45th` parallel
- Australia Day, `January 26`
- In Australia the Queen is represented by `the Governor-General`
- `1947`, New Zealand fully independent, `the Statute of Westminster`
- The ports of `Tauranga` and Auckland in New Zealand
- Belfast Agreement, `a Northern Ireland Assembly`
- the first language introduced to Ireland, `English`, during `the Norman invasion`
- the most Irish state, `Massachusetts`
- The Anglo-Saxons created the `Witan` to advise the king
- In 1215, King John was forced to sign `the Great Charter` (also known as *the baron's charter* or `the Magna Carta`)
- The Paris Conference, `the Versailles Treaty System`
- `The Hart-Celler Act`, changed the ethnic make-up of US
- Edward VI, Protestant, `the Reformation`
- Australian Constitution can be changed only by `referendum`
- the British government, Captain William Hobson signed `the Treaty of Waitangi` with Maori
- Australian, the first in the world adopt `suffrage` of all adult males
- `penal colony` in Australia
- first organization for modern football, `the Football Association`
- `James I`, translation of the Bible
- Edmund Cartwright's `power loom`
- 1997 the Labour Party, `Tony Blair`
- St.Augustine, `the first Archbishop of Canterbury`
- `Oliver Cromwell` declared Commonwealth
- Spanish-American War, Us gained `Puerto Rico` and `the island of Guam`
- Of the mainland states, `Texas` is the largest (`Alaska` is the largest of all the states)
- The Pilgrims founded settlement at `Plymouth`
- The North Atlantic Treaty, `military` alliance
- `1920`, `The Nineteenth Amendment` gave women the right to vote
- George Washington took the oath of office in `New York`
- The Americans defeated the British troops at `Saratoga`
- The Yalta summit, `the United Nations`
- `Omaha`, the agricultural capital of US
- `John D. Rockefeller`, the Standard Oil Company
- `The Great Lakes-St. Lawrence Lowlands`, the most populous region in Canada
- carrying `convicts` to Australia
- Eucalyptus trees, often called `gums`
- `The 2000 Paralympic Games`, Australian won the most medals
- The "White Australia" abandoned in `1973`
- New Zealand are separated by `Cook Strait`
- `Whale Rider`, a novel by Witi Ihimaera
- `first past the post` replaced by the mixed member proportional (MMP) in New Zealand
- `William Butler Yeats`, `George Bernard Shaw` and `Samuel Beckett` won Nobel Prizes for Literature
- The world's first duty-free airport, `Shannon Airport`
- `Dublin` is the center of Ireland's theatrical life
- The First English Civil War, the King's Cavaliers(Knights) and the supporters of Parliament `Roundheads`
- New Zealand's Maori name is `Aotearoa`
- `St.Partick` is still revered as the father of Ireland's Roman Catholic tradition
- `Nunavut` was created as homeland for the Inuit
- `The Bill of Rights`, the first ten amendments to the American Constitution
- `Ku Klux Klan`, K.K.K
- `Birmingham`, West Midlands
- Celtic languages, `Irish` is the strongest
- `The Parliament Act 1911` limit the powers of the Lords
- `Virginia`, the original 13 colonies
- `1924`, Native Americans were granted US citizenship by Congress
- all the states except `Nebraska` have a bicameral legislature
- In 1903, `the Wright brothers` made the first successful flight in an airplane
- the edge of a nuclear conflict, `the Cuban missile crisis`
- The compromise over slavery in 1850 allowed `California` to enter the Union as a free state
- The Great Society initiatives, `Lyndon B. Johnson`
- `The Interior Plains` lie between `the Canadian Shield` and `the Rocky Mountains`
- 1992, Canada ban `cod` fishing
- Schindler's List, `Thomas Keneally`
- The first female prime minister of New Zealand, Jenifer Shipley, took office in `1997`
- The central plain of Ireland, lakes, ridges and `bogs`
- The American Civil War and `Reconstruction`
- `The lord chancellor` is a member of all three branches of the government（最高法院院长、上议院院长、内阁阁员（掌玺大臣））
- East India Company was established in `1600`
- large mammals in Britain, `red deer` and `roe deer`
- Labor Party origins, `the Labor Representation Committee`
- transfer water to the areas of `lowland Britain`
- The Reform Act of 1832, gave the vote to many householders and tenants, base on `property value`
- the Constitutional Convention held in 1787. In 1790, `Rhode Island`.
- `Woodrow Wilson`, "we must be impartial in thought as well as in action"
- 91% of Australians describe themselves as "white" and a primarily `European` background.
- `Kakadu National Park`, World Heritage Site
- Australian Aborigines gained citizenship in `1967`
- `the Land for Settlements Act of 1892` promoted the division of large estates into smaller farms
- `Michelle Smith` Irish swimming gold medal
- `Dublin` publishing industry
- Canada highest point, `Mount Logan`
- `Sinn Fein` established an independent Irish Parliament under the leadership of Eamon de Valera
- The central region of Australia is called `the Outback` or "Bush", very few people
- London smog, `"clean air zones"`
- Ohio River `steel` industry
- the foreign-born element of the British population is concentrated in `inner-city areas`
- `Henry II`, the first king of the House of Plantagenet
- The Peasant Uprising of 1381 wa led by `Wat Tyler` and Jack Straw
- `Abraham Darby` succeeded in smelting iron with coke
- The result of the land enclosure in Ireland and the Scottish Highlands, `Mass emigration to the New World`
- `The discovery of gold at Witwatersrand` caused Boer War
- The largest fresh water lake, `Lake Superior`
- plantation farming by slaves was replaced by `the sharecropping system`
- Pennsylvania was established by `Quakers`
- the first and most significant of the watersheds that divide canada, is in `the Rocky Mountains`
- In Canada, `the judiciary` is independent of other government authorities
- the only instrument played in Ireland, `the Irish harp`
- `Elizabeth I`, lost the port of Calais
- `The Canterbury Tales` describes a group of pilgrims going to visit Thomas Becket's tomb.
- Henry VIII's struggle for a divorce and ended in `freedom from the Papacy`
- Women's `boxing`, the first time in London Olympics
- Margaret Thatcher's `Conservative Party` formed a new government
- Open University, `adults`
- `The midwest` is America's agricultural and industry center
...
- The US president `enforces laws`
- `Franklin D. Roosevelt`: "This nation asks for action, and action now." "The only thing we have to fear is fear itself."
- `Veterans Day` on November 11, was called Armistice Day from World War I
- `the Duryea brothers`, first gasoline-driven automobile
- "Ottawa" means `to trade`
- The explorer who suggested the name Australia was `Matthew Flinders`
- highest peak in New Zealand, `Mount Cook`
- Education in New Zealand is compulsory between the ages of `6 and 16`
- Seven kingdoms, have been given the name of `Heptarchy`
- New Zealand and Australia signed `the Canberra Pact`
- People legally defined as Indians are known as `status` Indians.
- `The Missouri Compromise`, allowing Maine to enter the Union as a "free" state
- When George VI died, Queen `Elizabeth II` was crowned
- Thatcher was removed by her own party because of her `opposition to European Union`
- In the UK, historic `counties` remain important cultural units and serve as a focus for local identity, though they have little administrative power.
- British culture industry accounts for `one-sixth` of the world's cultural exports
- In the UK, primary education `5 to 11`, then Secondary Education
- `The Articles of Confederation`, accepted by all the states in America by March 1781
- New Zealand lies in `temperate` latitudes
- New Zealand, `rugby football`
- the Governor-General in New Zealand holds a `five-year` term
- The name Great Britain came from the Act of Union united England and `Scotland`
- immediate cause of UK's entry into WWI: `the assassination of Franz Ferdinand`
- `Simon de Montfort` summoned the Great Council to meet at `Westminster`, which has been seen as the earliest parliament.
- `New England` was the chief center of the American War of Independence.
- cricket birthplace, `England`
- The English Civil War, also called `the Puritan Revolution`

## 对照表

### Land

|Nation|Size|divisions|geographical|climate|
|:---------:|:---------:|:---------:|:---------:|:---------:|
|UK||||maritime|
|US|4th|50 states|7 regions|humid continental|
|Canada|2nd|10 provinces and 3 territories|6 regions||
|Australia|6th||3 regions|hot and dry|
|New Zealand|||||
|Ireland||||western maritime|

### Government 

|Nation|Legislature|Upper|Lower|
|:---------:|:---------:|:---------:|:---------:|
|UK|Parliament|House of Lords|House of Commons|
|US|Congress|Senate|House of Commons|
...
- Irish:
  ...
  - `James Joyce`, Dublin "Bloomsday"
- American:
  - `Eugene O'Neill` (Nobel Prize) (playwright / `the father of American drama`)
- Canada:
...
- in `1485`, The English Renaissance started from
...
- at `Sarajevo` on June 28, `1914`, the `Austrian` Crown Prince was assassinated
...
- Wessex
  - Alfred the Great (The Viking and Danish Invasions)
  - King Edward the Confessor
- Norman
  - William the Conqueror (The Norman Conquest)
- Plantagenet
  - Edward III (The Hundred Years' War with France)
- Lancaster
- York
- Tudor
  - Henry VIII (Modern Age)
  - Mary I (Bloody Mary)
  - Elizabeth Ⅰ (The English Renaissance)
- Stuart (The Restoration and the Glorious Revolution of 1688)
  - James I
  - Charles I
  - Charles II (Civil Wars / The Commonwealth)
  - James II
  - Mary II
  - William III
  - Anne
...
`Birmingham`, `Liverpool`, `Manchester` in England,<br/>
`Edinburgh`, `Glasgow` in Scotland,<br/>
`Cardiff`, `Swansea` in Wales,<br/>
`Belfast`, `Londonderry` in Northern Ireland.
...
The largest lake in **Great Britain** is `Loch Lomond` 罗蒙湖,<br/>
the largest lake in **UK** is `Lough Neagh` 北爱尔兰内伊湖
...
Teutonic religion:
- Tuesday: Tiu **the god of war**
- Wednesday: Woden 众神之王奥丁
- Thursday: Thor 雷神
- Friday: Freya 爱情、美丽、生育、性欲、战争和黄金有关的女神
...
The American Constitution was finally adopted in 1789 by a narrow margin on the understanding that `a Bill of Rights would be amended` after the Constitution came into force.
...
`the Fourteenth Amendment`,  provided citizenship to all the former slaves.
...
In 1971, the Canadian government adopted a policy of multiculturalism and encouraged its immigrants to maintain their particular `cultural` heritages since then.

#### VI. Major Cities

`Montreal` is the largest French-speaking city outside France. (Quebec)

`Ottawa`, the capital city of Canada, is in the province of `Ontario`.

The largest city in Canada is `Toronto`. (Ontario)

The city that has an ice-free harbor as Canada's major outlet of the Pacific Ocean is `Vancouver`. (British-Columbia)
...
The mining industry brings in the largest share of Australia's export income.
...
a dormant volcano in the central plateau: `Tongariro`.
