...
### What is the effect of the UK's climate on the Englishman's character?

It has been said that the **uncertainty** about the weather has had a **definite effect** upon the Englishman's character. It tends to make him **cautious**, for example.

#### What languages contributed to the shaping of the English language in history?

Modern English is derived mainly from the `Germanic dialects` spoken by the Angles, Saxons, and Jutes and heavily influenced by the language of the Danes(Vikings) and `French`.
...
### Why didn't the Romans totally occupy Britain?

Two reasons:
- First, some **parts** of the country **resisted**.
- Second, **Roman** troops were often withdrawn from Britain to fight in other parts of the Roman Empire.
